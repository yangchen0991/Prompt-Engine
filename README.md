...
内置专业级提示词工程系统，基于 **SCULPT (Subject·Composition·Universe·Light·Print·Texture)** 六维框架：

- `[S]` 主体 — 微观特征与多主体空间关系
- `[C]` 构图 — 专业摄影术语（shot on Canon R5, 50mm f/1.4...）
- `[U]` 风格 — 视觉流派与媒介质感
- `[L]` 光影 — 具体灯光与色彩科学参数
- `[P]` 文字 — 渲染文字精确排版描述
- `[T]` 材质 — 微观质感（PBR, film grain, skin texture...）

> 覆盖 8 大实战场景：电商主图、社交海报、App UI、人像摄影、信息图表、Logo 设计、插画绘本、风格迁移。
